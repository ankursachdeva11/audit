...
var uid='';
var unique_id='';
function callPaypal( productName , product_price , form_id , project_id , uid , uuid)
{
//alert('start payment'+amt+productName+currencyCode+'  '+clientID+' ' +Business);
   //------------------ start paypal process------------------
           ...
           //	   var productName="My Product";
			...
			clientID="ARMA2BCJjwAUDR1KnL7R8sR-gFm_9TaQLoMGyjOgN5LjcjWqfFgCCeEg1i6-";
           	 //clientID="AV5QiRDedW59PSa86dZXuiQ9MWb2hIl5ieB_taqfFVTOIvf5yblQle4k3hvQ";
          Business="sales@qhse-riskconsultants.com";  
             ...
             $.ajax({url: "http://qhse-riskapplications.com/m/combinePurchaseSuccess.php?pfid=" + fid + "&pid=" + pid + "&uid=" + uid + "&uuid=" + unique_id,
				dataType: "text",
				beforeSend: function() {
					$.mobile.showPageLoadingMsg(true);
				},
